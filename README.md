...
1. Codes folder: Notebook files where you can find the modelisation/data analysis of the different component of the DART trading strategy. You will also find the implementation of a Naive and a more sophisticated DART trading stragy with backetsting.
