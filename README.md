# ERCOT DART Power Trading Project

This project is an implementation of a DART trading strategy on the ERCOT Market. In this repository you can find:

1. Codes folder: Notebook files where you can find the modelisation/data analysis of the different component of the DART trading strategy. You will also find the implementation of a Naive and a more sophisticated DART trading strategy (using ML classifier) with backtesting.
